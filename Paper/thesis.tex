...
\include{Paper/0preface}
\include{Paper/1geo_to_graphs}
\include{Paper/2colorings}
\include{Paper/3coloring_rels}
\include{Paper/4computations}
\include{Paper/5symmetries}
\include{Paper/6count_partitions_indepsets}
\include{Paper/9epilog}
