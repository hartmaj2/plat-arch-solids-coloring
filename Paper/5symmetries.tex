...
\bottomrule
\end{tabular}
\caption{Lower and upper bounds for the number of equivalence classes of the relabeling-automorphism relation based on the number of equivalence classes of the relabeling relation.}
...
\bottomrule
\end{tabular}
\caption{Lower and upper bounds for the number of equivalence classes of the relabeling-automorphism relation based on the number of equivalence classes of the $\sim$ relation.}
...
\vtodo{Demonstrate results from using this algorithm}
