...
\todo[JF]{to se obvykle nazývá "Preliminaries"}
...
\todo[JF]{míto amount (množství) pište  raději number (počet)}
...
\todo[JF]{more rigorous je netaktní, co třeba more detailed nebo more selfcontained}
...
\todo[JF]{místo natural number bývá zvykem psát positive integer}
