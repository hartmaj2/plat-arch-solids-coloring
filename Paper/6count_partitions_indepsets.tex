...
\begin{figure}[H]
    ...
    \caption{Equivalence classes of relabeling-automorphism of octahedron for $n$ from $3$ up to $6$. The vector under each partition corresponds to its size sequence.}
