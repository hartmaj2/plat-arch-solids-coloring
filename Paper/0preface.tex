...
\todo[JF]{Pěkné, to je ono. Orbital jsem zdůraznil, protože to je netradiční pojem.

Jen bych se vyhnul negativnímu "we do not know of any way". 

Možná bych za slovy "structurally different colorings." napsal jen "This leads to the problem of counting partitions of the vertex set into independent sets up to symmetries for which we provide a partial answer obtained by computer calculation."}
