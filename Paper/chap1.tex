...
So far, the particular colorings we have considered were all quite similar to each other. In what sense? All of their coloring rules were based of the notion of adjacency of some elements. Neighboring vertices could not have same color, incident edges etc. There exists other types of colorings, where the coloring rules are based on other concepts such as connectivity or the particular values of the colors. One such example is the \textit{rainbow coloring}.
