...
\iffalse
%\else
%% JF pokus o jiné formátování, ale ani to není nijak zvlášť přehledné
% https://tex.stackexchange.com/questions/483300/how-to-format-a-long-polynomial
\begin{description}
   \item[truncated octahedron] \hfill\\ 
$x^{24} - 36x^{23} + 630x^{22} - 7134x^{21} + 58707x^{20} - 373816x^{19} + 1914823x^{18} - 8098890x^{17} + 28806937x^{16} - 87308340x^{15} + 227623087x^{14} - 513887650x^{13} + 1008990864x^{12} - 1726780052x^{11} + 2576178723x^{10} - 3343211267x^{9} + 3755216148x^{8} - 3618864524x^{7} + 2949553512x^{6} - 1987203924x^{5} + 1066396109x^{4} - 427989031x^{3} + 114056146x^{2} - 15071023x$
   
   \item[truncated tetrahedron] \hfill\\
$x^{12} - 18x^{11} + 149x^{10} - 752x^{9} + 2586x^{8} - 6408x^{7} + 11774x^{6} - 16189x^{5} + 16468x^{4} - 11869x^{3} + 5442x^{2} - 1184x$   
\end{description}
\fi
