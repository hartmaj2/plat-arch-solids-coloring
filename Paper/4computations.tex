...
If we are interested only in colorings different up to symmetries, we need to use a method that is describe in chapters \ref{chap:clrings-up-to-symmetries} and \ref{chap:orbital-chromatic-polynomial}.
