...
\begin{claim}
    Let $K_{k \times n}$ be a complete $k$-partite graph where each independent set has size $n$. Then it holds that: \[P(K_{k \times 2},x) = \sum_{i=0}^{k} \binom{k}{i} P(K_{2n-i},x)\]
\end{claim}
