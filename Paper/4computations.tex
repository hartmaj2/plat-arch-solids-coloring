...
A particular example that demonstrates the claim above is the graph of octahedron $K_{2,2,2}$. According to the formula, we have \[ P(K_{2,2,2},x) = P(K_6,x)+3P(K_5,x) + 3P(K_4,x)+P(K_3,x)\] as illustrated in the figure below.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Resources/Figs/octahedral_demo.pdf}
