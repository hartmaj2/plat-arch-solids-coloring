...
\vtodo{Add table with example evaluations of the chromatic polynomial}
...
\vtodo{Show how we can get the number of colorings using exactly n colors from the chromatic polynomial}

\vtodo{Add example that shows all the colorings of some graph. Demonstrate the problem that rotations are included multiple times and that relabelings are also counted multiple times.}
