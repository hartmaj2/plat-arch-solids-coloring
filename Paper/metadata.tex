...
\def\Dedication{
I would like to give many thanks to my supervisor, doc. RNDr. Jiří Fiala, Ph.D., especially for his positive and proactive attitude. I am grateful for all the helpful insights and recommendations that he gave me throughout his supervision of this thesis.

Nevertheless, nothing of this would be possible without my family, who kindly respected that I did not have as much time for them as I wished, and also provided me with valuable resources such as food and shelter.

Many thanks also belong to my friends from Matfyz, who listened to my complaints and often provided me with useful tips to improve parts of the thesis. I would like to explicitly mention Štěpán Vodseďálek, Hana Salavcová and Jakub Smolík.

I would also like to express my gratitude towards developers of the SageMath software. They did and are still doing great work on software that provided me with tools that I could use for most of my algorithms, saving me from having to reinvent the wheel.

Lastly, I would like to thank Mgr. Martin Mareš, Ph.D. and others, who took part in creating the \LaTeX{} template that was ready to be used for this thesis.
}
...
\def\ThesisKeywords{
graph coloring \sep chromatic polynomial \sep Platonic solids
}
...
barvení grafů \sep chromatický polynom  \sep platónská tělesa
}
