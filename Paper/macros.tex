...
%%% MY MACROS AND SUPERVISOR MACROS FOR TODO NOTES

\makeatletter
\define@key{todonotes}{JF}[]{\setkeys{todonotes}{author=JF,textcolor=purple}}%
\makeatother    

\newcommand{\vtodo}[1]{\vspace{5pt}\todo{TODO: #1}}

\newcommand{\tabemph}[1]{\textcolor{red}{#1}}
...
%
% \setboolean{useHighlights}{true}
\setboolean{useHighlights}{false} 
% set true/false to toggle highlights
...
\newcommand{\Cycles}{\operatorname{Cycles}}
...
% UNCOMMENT FOLLOWING IF USING ALGORITHM OR LISTING
...
%%% of programs.
% UNCOMMENT IF USING ALGORITHM OR VERBATIM
